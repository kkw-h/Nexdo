...
SOURCE_URL_DEFAULT="https://raw.githubusercontent.com/kkw-h/Nexdo/main/app/altstore/source.json"
SOURCE_URL="${ALTSTORE_SOURCE_URL:-$SOURCE_URL_DEFAULT}"
ICON_URL_DEFAULT="https://raw.githubusercontent.com/kkw-h/Nexdo/main/app/assets/app_icon.png"
